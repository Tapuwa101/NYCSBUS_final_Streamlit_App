...
- Route-level safety and operational monitoring
- Interactive map of risk and hotspot signals
- Borough and risk-level filters
- Automated severity scoring
- Trend validation for persistent signals
- Review queue for operational follow-up
